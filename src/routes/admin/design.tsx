...
import { VerdictChips, CampaignBadge } from "./layout";
          ...
          <div class="max-w-4xl mx-auto px-4 py-8 sm:px-6 sm:py-12">
            ...
            <section class="mb-16">
              ...
              <p class="text-sm text-gray-500 mb-4">
                Blue-600 for primary actions, gray-700 for headings, gray-500 for secondary text.
              </p>
            ...
            <section class="mb-16">
              ...
              <div class="space-y-3">
                <div>
                  <span class="text-2xl font-bold text-gray-900">Page Title</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">text-2xl font-bold</span>
                </div>
                <div>
                  <span class="text-xl font-semibold text-gray-800">Section Heading</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">text-xl font-semibold</span>
                </div>
                <div>
                  <span class="text-sm font-medium text-gray-700">Label / Field Heading</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">text-sm font-medium text-gray-700</span>
                </div>
                <div>
                  <span class="text-sm text-gray-700">Body text</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">text-sm text-gray-700</span>
                </div>
                <div>
                  <span class="text-sm text-gray-500">Secondary text</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">text-sm text-gray-500</span>
                </div>
                <div>
                  <span class="text-xs text-gray-400">Muted / Meta text</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">text-xs text-gray-400</span>
                </div>
                <div>
                  <span class="text-sm font-mono text-gray-600">Monospace / Code</span>{" "}
                  <span class="text-xs text-gray-400 ml-2">font-mono</span>
                </div>
              </div>
            </section>
            ...
            <section class="mb-16">
              ...
              <Table>
                ...
                <tbody>
                  ...
                  <tr>
                    <Td>Rowan Hughes</Td>
                    <Td>rowan@example.com</Td>
                    <Td>
                      <span class="inline-block px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                        blocklisted
                      </span>
                    </Td>
                  ...
                  <tr>
                    ...
                    <Td>
                      <span class="inline-block px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
                        unconfirmed
                      </span>
                    </Td>
            ...
            <section class="mb-16">
              ...
              <h3 class="text-sm font-medium text-gray-500 mb-3">Standard card</h3>
              <Card>
                <p class="text-sm text-gray-700 m-0">
                  This is a standard card used for forms, detail sections, and grouped content.
                </p>
              </Card>

              <h3 class="text-sm font-medium text-gray-500 mb-3">Page header</h3>
              <Card>
            ...
            <section class="mb-16">
              ...
              <h3 class="text-sm font-medium text-gray-500 mb-3">Campaign status</h3>
              <div class="flex flex-wrap gap-3 mb-6">
              ...
              <h3 class="text-sm font-medium text-gray-500 mb-3">Subscriber status</h3>
              <div class="flex flex-wrap gap-3 mb-6">
                <span class="inline-block px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                  active
                </span>
              ...
              <h3 class="text-sm font-medium text-gray-500 mb-3">Verdict chips</h3>
            ...
            <section class="mb-16">
              ...
              <div class="bg-white border border-gray-200 rounded-lg p-5 mb-4">
                ...
                <p class="text-sm text-gray-700 m-0">
                  Hey, just wanted to say the newsletter is looking great. Keep it up!
                </p>
              </div>
              ...
              <div class="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-4">
                ...
                <pre class="text-sm text-gray-700 whitespace-pre-wrap font-sans leading-relaxed m-0">
            ...
            <section class="mb-16">
              ...
              <ul class="space-y-2 text-sm text-gray-600">
                <li>
                  <strong>Rounded corners</strong> - Soft, rounded edges on cards, inputs, and buttons
                </li>
                <li>
                  <strong>Borders over shadows</strong> - Use border-gray-200 instead of shadow
                </li>
                <li>
                  <strong>Blue-600 primary</strong> - Primary actions and links
                </li>
                <li>
                  <strong>Compact tables</strong> - Light header, thin borders, small text
                </li>
                <li>
                  <strong>Consistent spacing</strong> - mb-4 for form groups, mb-6 for sections, gap-3/4 for flex
                </li>
                <li>
                  <strong>White cards on gray-50 bg</strong> - Content areas on subtle background
                </li>
                <li>
                  <strong>Semantic colors</strong> - Green for success, red for danger, amber for warning, blue for info
                </li>
                <li>
                  <strong>Minimal chrome</strong> - No unnecessary decoration, content first
                </li>
                <li>
                  <strong>Visible focus</strong> - Keyboard focus is clear on every interactive element
                </li>
                <li>
                  <strong>Responsive by default</strong> - Navigation scrolls and tables stay usable on narrow screens
                </li>
              </ul>
            </section>

            <footer class="border-t border-gray-200 pt-6 pb-12 text-xs text-gray-400">lists design system</footer>
          </div>
        </body>
      </html>,
    );
